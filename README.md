...
- Atuo como Estagiário de desenvolvimento de software na Caixa Econômica Federal.
- Atualmente estou me dedicando e aprendendo tudo relacionado à  **Linguagem C#**, **.NET**, **SQL Server**; além de estudar outras tecnologias e ferramentas como **Angular**, **Vue.js**, **Docker**, **Azure Data Studio**, **Postman**.
...
<a href="https://github.com/piressjp" target="_blank">
